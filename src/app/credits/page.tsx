  ...
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-5 py-12">
        <h1 className="font-display text-4xl text-fg">Credits</h1>
        <div className="mt-6 space-y-4 leading-relaxed text-muted">
          ...
          <h2 className="pt-4 font-display text-xl text-fg">Type</h2>
          <p className="text-sm text-dim">
            Kalnia, Tiro Devanagari Hindi, Onest, and Geist Mono — all open-source, served via Google
            Fonts.
          </p>
          <h2 className="pt-4 font-display text-xl text-fg">A note</h2>
          <p className="text-sm text-dim">
